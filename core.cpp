...
cout << "ERROR! :127 OpenGL3Renderer& cegui_renderer = OpenGL3Renderer::create(Sizef(800.f, 600.f));" << endl;
    ...
    SchemeManager::getSingleton().createFromFile("GameMenu.scheme", "schemes");
...
void initWindows()
{
    ...
    // load layout
    Window* root = WindowManager::getSingleton().loadLayoutFromFile("GameMenu.layout");
